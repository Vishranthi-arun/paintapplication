...
<html lang="en">
  <head>
    ...
    <style>
        ...
        #bgimg{
          background-image: url("img/paint.v1.png");
        }
        #shooky{
  ...
  <body id="bgimg">
    ...
    color:#ffffff;
    font-weight: bolder;
    font-size: larger;">Paint Application Program, Developed by Vishranthi A</p>
  </body>
</html>
```
## OUTPUT:
...
![OUTPUT](./paintapp/static/img/blank-canvas.png)

## DRAWN CANVAS:

![OUTPUT](./paintapp/static/img/drawn-canvas.png)

## SIZE CHANGE:

![OUTPUT](./paintapp/static/img/size-change.png)
## Result:
